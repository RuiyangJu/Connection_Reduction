...
class DenseNet(nn.Module):
    def __init__(self, num_classes):
        ...
        self.denseblock2 = self._make_dense_block(denseblock_2, 128)
        self.denseblock3 = self._make_dense_block(denseblock_3, 160)
        self.denseblock4 = self._make_dense_block(denseblock_4, 192)

        self.transitionlayer1 = self._make_transition_layer(transitionlayer, in_channels=256, out_channels=128)
        self.transitionlayer2 = self._make_transition_layer(transitionlayer, in_channels=320, out_channels=160)
        self.transitionlayer3 = self._make_transition_layer(transitionlayer, in_channels=384, out_channels=192)
