...
class denseblock_1(nn.Module):
    def __init__(self, in_channels):
        ...
        self.conv10 = nn.Conv2d(in_channels=288, out_channels=32, kernel_size=3, stride=1, padding=1)
...
class denseblock_2(nn.Module):
    def __init__(self, in_channels):
        ...
        self.conv9 = nn.Conv2d(in_channels=256, out_channels=32, kernel_size=3, stride=1, padding=1)
        self.conv10 = nn.Conv2d(in_channels=288, out_channels=32, kernel_size=3, stride=1, padding=1)
        self.conv11 = nn.Conv2d(in_channels=320, out_channels=32, kernel_size=3, stride=1, padding=1)
        self.conv12 = nn.Conv2d(in_channels=352, out_channels=32, kernel_size=3, stride=1, padding=1)
...
class denseblock_3(nn.Module):
    def __init__(self, in_channels):
        ...
        self.conv11 = nn.Conv2d(in_channels=320, out_channels=32, kernel_size=3, stride=1, padding=1)
        self.conv12 = nn.Conv2d(in_channels=352, out_channels=32, kernel_size=3, stride=1, padding=1)
        self.conv13 = nn.Conv2d(in_channels=384, out_channels=32, kernel_size=3, stride=1, padding=1)
        self.conv14 = nn.Conv2d(in_channels=416, out_channels=32, kernel_size=3, stride=1, padding=1)
        self.conv15 = nn.Conv2d(in_channels=448, out_channels=32, kernel_size=3, stride=1, padding=1)
        self.conv16 = nn.Conv2d(in_channels=480, out_channels=32, kernel_size=3, stride=1, padding=1)        
...
class DenseNet(nn.Module):
    def __init__(self, num_classes):
        ...
        self.denseblock2 = self._make_dense_block(denseblock_2, 160)
        self.denseblock3 = self._make_dense_block(denseblock_3, 192)
        self.denseblock4 = self._make_dense_block(denseblock_4, 256)

        self.transitionlayer1 = self._make_transition_layer(transitionlayer, in_channels=320, out_channels=160)
        self.transitionlayer2 = self._make_transition_layer(transitionlayer, in_channels=384, out_channels=192)
        self.transitionlayer3 = self._make_transition_layer(transitionlayer, in_channels=512, out_channels=256)
        self.transitionlayer4 = self._make_transition_layer(transitionlayer, in_channels=256, out_channels=128)
