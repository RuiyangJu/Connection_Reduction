...
class DenseNet(nn.Module):
    def __init__(self, num_classes):
        ...
        self.denseblock2 = self._make_dense_block(denseblock_2, 80)
        self.denseblock3 = self._make_dense_block(denseblock_3, 96)
        self.denseblock4 = self._make_dense_block(denseblock_4, 112)

        self.transitionlayer1 = self._make_transition_layer(transitionlayer, in_channels=160, out_channels=80)
        self.transitionlayer2 = self._make_transition_layer(transitionlayer, in_channels=192, out_channels=96)
        self.transitionlayer3 = self._make_transition_layer(transitionlayer, in_channels=224, out_channels=112)
